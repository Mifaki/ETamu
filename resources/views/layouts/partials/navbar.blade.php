<nav id="navbar" class="fixed z-10 top-0 left-0 w-full transition duration-300 ease-in-out transparent">
    <div class="w-[95%] md:w-[80%] flex flex-wrap items-center justify-between mx-auto py-4">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul class="flex flex-col md:content-center p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-white md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
                <li>
