...
@section('title', 'Tambah Kategori Tamu - Dashboard')
...
@section('content')
    <div class="flex items-center justify-center h-full">
        <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md max-w-lg w-full">
            ...
            <form action="{{ route('dashboard.guest-categories.store') }}" method="POST">
                @csrf
                ...
                <div class="flex justify-end">
                    <a href="{{ route('dashboard.guest-categories.index') }}"
