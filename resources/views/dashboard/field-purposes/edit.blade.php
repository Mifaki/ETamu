...
<?php
    $purpose = [
        'id'                 => 1,
        'nama_tujuan_bidang' => 'Bidang Statistik',
    ];
?>
...
<div class="flex items-center justify-center min-h-screen">
    <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md max-w-lg w-full">
        ...
        <form action="{{ route('dashboard.field-purposes.update', ['id' => $purpose['id']]) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-6">
                <label class="block text-gray-700 dark:text-gray-200" for="nama_tujuan_bidang">
                    Nama Tujuan Bidang
                </label>
                <input
                    type="text"
                    id="nama_tujuan_bidang"
                    name="nama_tujuan_bidang"
                    ...
                    placeholder="Masukkan tujuan bidang"
                    value="{{ $purpose['nama_tujuan_bidang'] }}"
                    required
                />
            </div>
