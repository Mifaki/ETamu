    ...
    <div class="container mx-auto px-4">
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <form action="{{ route('reservation.store') }}" method="POST" enctype="multipart/form-data" class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="mt-2 space-y-4">
                        <div class="flex items-center">
                            ...
                            <label for="individual" class="ml-3 block text-sm font-medium text-gray-700 dark:text-gray-300">
                                Perseorangan
                            </label>
                        </div>
                        <div class="flex items-center">
                            ...
                            <label for="organization" class="ml-3 block text-sm font-medium text-gray-700 dark:text-gray-300">
                ...
                <div>
                    <label for="guest_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nama Tamu</label>
                ...
                <div>
                    <label for="guest_category_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Kategori Tamu</label>
                    <select id="guest_category_id" name="guest_category_id" 
                        ...
                        @foreach($guestCategories as $category)
                            <option value="{{ $category->id }}" {{ old('guest_category_id') == $category->id ? 'selected' : '' }}>
                                {{ $category->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    <label for="organization" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Organisasi</label>
                ...
                <div>
                    <label for="guest_purpose_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Keperluan</label>
                    <select id="guest_purpose_id" name="guest_purpose_id" 
                        ...
                        @foreach($guestPurposes as $purpose)
                            <option value="{{ $purpose->id }}" {{ old('guest_purpose_id') == $purpose->id ? 'selected' : '' }}>
                                {{ $purpose->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    <label for="phone_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300">No HP/Whatsapp</label>
                ...
                <div>
                    <label for="field_purpose_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Bertemu Bidang</label>
                    <select id="field_purpose_id" name="field_purpose_id" 
                        ...
                        @foreach($fieldPurposes as $purpose)
                            <option value="{{ $purpose->id }}" {{ old('field_purpose_id') == $purpose->id ? 'selected' : '' }}>
                                {{ $purpose->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <div class="flex items-center justify-center gap-2">
                        <div class="flex-1">
                            <label for="meeting_time_start" class="block text-xs text-gray-500 dark:text-gray-400">Mulai</label>
                        ...
                        <div class="flex-1">
                            <label for="meeting_time_end" class="block text-xs text-gray-500 dark:text-gray-400">Selesai</label>
                ...
                <div id="id_card_upload" class="hidden">
                    <label for="id_card" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Upload KTP</label>
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Format: JPG, JPEG, PNG, PDF (Maks. 3MB)</p>
                    @error('id_card')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div id="organization_document_upload" class="hidden">
                    <label for="organization_document" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Upload SK Badan Hukum</label>
